"""DeltaNet chunkwise L2 归一化 Triton kernel。
...
@triton.jit
def _delta_net_chunk_l2norm_fwd_kernel(
    x_ptr,
    T,
    K,
    out_ptr,
...
def delta_net_chunk_l2norm_fwd(x):
    """L2 归一化前向封装。
    ...
    _delta_net_chunk_l2norm_fwd_kernel[grid](
        x_2d,
        B * H * T,
        K,
        out_2d,
...
@triton.jit
def _delta_net_chunk_l2norm_bwd_kernel(
    x_ptr,
    inv_norm_ptr,
    dout_ptr,
    T,
...
def delta_net_chunk_l2norm_bwd(x, inv_norm, dout):
    """L2 归一化反向封装。
    ...
    _delta_net_chunk_l2norm_bwd_kernel[grid](
        x_2d,
        inv_norm_1d,
        dout_2d,
        B * H * T,
