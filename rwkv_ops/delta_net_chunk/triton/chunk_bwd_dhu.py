"""DeltaNet chunkwise 状态反向扫描 Triton kernel。
...
@triton.jit
def _delta_net_chunk_bwd_dhu_kernel(
    q_ptr,
    k_ptr,
    w_ptr,
    do_ptr,
...
def delta_net_chunk_bwd_dhu(q, k, w, do, dv_local, dht=None, scale=1.0, chunk_size=64):
    """状态反向扫描封装。
    ...
    _delta_net_chunk_bwd_dhu_kernel[grid](
        q,
        k,
        w,
        do,
