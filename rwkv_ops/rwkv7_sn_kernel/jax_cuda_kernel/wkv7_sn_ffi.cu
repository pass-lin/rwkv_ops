    ...
    ffi::ResultBuffer<ffi::F32>  sa)
{
    ...
    if (err != cudaSuccess)
        return ffi::Error::Internal(
            std::string("CUDA forward_kernel_sn error: ") + cudaGetErrorString(err));
    ...
    ffi::ResultBuffer<ffi::BF16> db)
{
    ...
    if (err != cudaSuccess)
        return ffi::Error::Internal(
            std::string("CUDA backward_kernel_sn error: ") + cudaGetErrorString(err));
    return ffi::Error::Success();
}
    ...
    ffi::ResultBuffer<ffi::F32>  s)
{
    ...
    if (err != cudaSuccess)
        return ffi::Error::Internal(
            std::string("CUDA forward_inference_kernel_sn error: ") + cudaGetErrorString(err));
    return ffi::Error::Success();
}
    ...
    ffi::ResultBuffer<ffi::F32>  sa)
{
    ...
    if (err != cudaSuccess)
        return ffi::Error::Internal(
            std::string("CUDA forward_kernel_sn_no_mask error: ") + cudaGetErrorString(err));
    return ffi::Error::Success();
}
    ...
    ffi::ResultBuffer<ffi::BF16> db)
{
    ...
    if (err != cudaSuccess)
        return ffi::Error::Internal(
            std::string("CUDA backward_kernel_sn_no_mask error: ") + cudaGetErrorString(err));
    return ffi::Error::Success();
}
    ...
    ffi::ResultBuffer<ffi::F32>  s)
{
    ...
    if (err != cudaSuccess)
        return ffi::Error::Internal(
            std::string("CUDA forward_inference_kernel_sn_no_mask error: ") + cudaGetErrorString(err));
    return ffi::Error::Success();
}
...
XLA_FFI_DEFINE_HANDLER_SYMBOL(
    Wkv7SnInference, WKV7SnInferenceHost,
    ffi::Ffi::Bind()
        .Ctx<ffi::PlatformStream<cudaStream_t>>()
        .Arg<ffi::Buffer<ffi::BF16>>()
        .Arg<ffi::Buffer<ffi::BF16>>()
...
XLA_FFI_DEFINE_HANDLER_SYMBOL(
    Wkv7SnFwdNoMask, WKV7SnFwdNoMaskHost,
    ffi::Ffi::Bind()
        .Ctx<ffi::PlatformStream<cudaStream_t>>()
        .Arg<ffi::Buffer<ffi::BF16>>()
        .Arg<ffi::Buffer<ffi::BF16>>()
...
XLA_FFI_DEFINE_HANDLER_SYMBOL(
    Wkv7SnBwdNoMask, WKV7SnBwdNoMaskHost,
    ffi::Ffi::Bind()
        .Ctx<ffi::PlatformStream<cudaStream_t>>()
        .Arg<ffi::Buffer<ffi::BF16>>()
        .Arg<ffi::Buffer<ffi::BF16>>()
...
XLA_FFI_DEFINE_HANDLER_SYMBOL(
    Wkv7SnInferenceNoMask, WKV7SnInferenceNoMaskHost,
    ffi::Ffi::Bind()
        .Ctx<ffi::PlatformStream<cudaStream_t>>()
        .Arg<ffi::Buffer<ffi::BF16>>()
        .Arg<ffi::Buffer<ffi::BF16>>()
