...
from rwkv_ops.gdn_recurrent_sane.torch_cuda_kernel.gdn_recurrent_sane_torch import (
    gated_delta_net_recurrent_sane as gdn_cuda_recurrent,
    gated_delta_net_recurrent_sane_inference as gdn_cuda_inference,
    gated_delta_net_recurrent_sane_single_step as gdn_cuda_single_step,
)
...
def _gdn_sane_grads(fn, q, k, v, g, beta, tau, mask, h0, head_first=None):
    ...
    out, state = fn(q, k, v, g, beta, tau, **kwargs)
...
@pytest.mark.torch
def test_gdn_sane_cuda_inference_arbitrary_length_matches_native(
...
@pytest.mark.torch
def test_gdn_sane_cuda_single_step_do_sane_matches_native(
    gdn_sane_inputs, gdn_sane_cuda_device
):
...
@pytest.mark.torch
def test_gdn_sane_cuda_single_step_do_skip_matches_original_gdn(
    gdn_sane_inputs, gdn_sane_cuda_device
):
...
@pytest.mark.torch
def test_gdn_sane_cuda_mask_all_ones_matches_no_mask(
    gdn_sane_inputs, gdn_sane_cuda_device
):
    ...
    with pytest.warns(UserWarning, match="mask is None"):
        out_uncond, state_uncond = gdn_cuda_recurrent(
...
@pytest.mark.torch
def test_gdn_sane_cuda_mask_all_zeros_matches_original_gdn(
    gdn_sane_inputs, gdn_sane_cuda_device
):
...
@pytest.mark.torch
def test_gdn_sane_cuda_bfloat16(gdn_sane_inputs, gdn_sane_cuda_device):
...
@pytest.mark.torch
@pytest.mark.slow
def test_gdn_sane_cuda_recurrent_chunk_size_8_matches_native(
    gdn_sane_inputs, gdn_sane_cuda_device
):
...
@pytest.mark.torch
@pytest.mark.slow
def test_gdn_sane_cuda_bwd_chunk_size_8_matches_native(
    gdn_sane_inputs, gdn_sane_cuda_device
):
    ...
    grads_cuda = _gdn_sane_grads(op_cuda, q, k, v, g, beta, tau8, mask8, h0)
...
@pytest.mark.torch
@pytest.mark.slow
def test_gdn_sane_cuda_inference_chunk_size_8_matches_native(
    gdn_sane_inputs, gdn_sane_cuda_device
):
...
@pytest.mark.torch
@pytest.mark.slow
def test_gdn_sane_cuda_no_final_state_chunk_size_8(
    gdn_sane_inputs, gdn_sane_cuda_device
):
...
@pytest.mark.torch
@pytest.mark.slow
def test_gdn_sane_cuda_mask_all_ones_matches_no_mask_chunk_size_8(
    gdn_sane_inputs, gdn_sane_cuda_device
):
...
@pytest.mark.torch
@pytest.mark.slow
def test_gdn_sane_cuda_mask_all_zeros_matches_original_gdn_chunk_size_8(
    gdn_sane_inputs, gdn_sane_cuda_device
):
...
@pytest.mark.torch
@pytest.mark.slow
def test_gdn_sane_cuda_bfloat16_chunk_size_8(gdn_sane_inputs, gdn_sane_cuda_device):
...
@pytest.mark.torch
def test_gdn_sane_cuda_no_mask_fwd_matches_native(
    gdn_sane_inputs, gdn_sane_cuda_device
):
...
@pytest.mark.torch
@pytest.mark.slow
def test_gdn_sane_cuda_no_mask_bwd_matches_native(
    gdn_sane_inputs, gdn_sane_cuda_device
):
    ...
    grads_cuda = _run_and_grad(gdn_cuda_recurrent)
...
@pytest.mark.torch
def test_gdn_sane_cuda_output_final_state_false_ignores_mask(
    gdn_sane_inputs, gdn_sane_cuda_device
):
    ...
    out_no_mask, _ = gdn_cuda_recurrent(
