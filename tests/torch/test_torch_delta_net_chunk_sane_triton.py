...
@pytest.mark.torch
def test_chunk_sane_triton_no_mask_fwd_vs_native(delta_net_sane_inputs, device):
...
@pytest.mark.torch
@pytest.mark.slow
def test_chunk_sane_triton_no_mask_bwd_vs_native(delta_net_sane_inputs, device):
