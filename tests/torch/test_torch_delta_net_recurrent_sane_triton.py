...
@pytest.mark.torch
@pytest.mark.slow
def test_dn_sane_triton_recurrent_chunk_size_8_matches_native(
    delta_net_sane_inputs, dn_sane_cuda_device
):
    ...
    op_tri = get_delta_net_recurrent_sane(KERNEL_TYPE="triton", chunk_size=8)
...
@pytest.mark.torch
@pytest.mark.slow
def test_dn_sane_triton_bwd_chunk_size_8_matches_native(
    delta_net_sane_inputs, dn_sane_cuda_device
):
    ...
    grads_tri = _dn_sane_grads(op_tri, q, k, v, beta, tau8, mask8, h0)
...
@pytest.mark.torch
@pytest.mark.slow
def test_dn_sane_triton_inference_chunk_size_8_matches_native(
    delta_net_sane_inputs, dn_sane_cuda_device
):
    ...
    op_tri = get_delta_net_recurrent_sane_inference(KERNEL_TYPE="triton", chunk_size=8)
...
@pytest.mark.torch
@pytest.mark.slow
def test_dn_sane_triton_no_final_state_chunk_size_8(
    delta_net_sane_inputs, dn_sane_cuda_device
):
...
@pytest.mark.torch
@pytest.mark.slow
def test_dn_sane_triton_mask_all_ones_matches_no_mask_chunk_size_8(
    delta_net_sane_inputs, dn_sane_cuda_device
):
...
@pytest.mark.torch
@pytest.mark.slow
def test_dn_sane_triton_mask_all_zeros_matches_original_gdn_chunk_size_8(
    delta_net_sane_inputs, dn_sane_cuda_device
):
...
@pytest.mark.torch
@pytest.mark.slow
def test_dn_sane_triton_bfloat16_chunk_size_8(
    delta_net_sane_inputs, dn_sane_cuda_device
):
