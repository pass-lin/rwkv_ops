"""DeltaNet-SANE 原生 Keras 实现的数值等价性测试（JAX 后端）。
...
_delta_net_chunk_sane_mod = _load_native_module(
    "delta_net_chunk_sane_native", "rwkv_ops/delta_net_chunk_sane/native_keras_op.py"
)
_delta_net_recurrent_mod = _load_native_module(
    "delta_net_recurrent_native", "rwkv_ops/delta_net_recurrent/native_keras_op.py"
)
_delta_net_recurrent_sane_mod = _load_native_module(
    "delta_net_recurrent_sane_native",
    "rwkv_ops/delta_net_recurrent_sane/native_keras_op.py",
)

delta_net_chunk = _delta_net_chunk_mod.delta_net_chunk
delta_net_chunk_sane = _delta_net_chunk_sane_mod.delta_net_chunk_sane
delta_net_recurrent = _delta_net_recurrent_mod.delta_net_recurrent
delta_net_recurrent_sane = _delta_net_recurrent_sane_mod.delta_net_recurrent_sane
delta_net_recurrent_sane_inference = (
    _delta_net_recurrent_sane_mod.delta_net_recurrent_sane_inference
)
delta_net_recurrent_sane_single_step = (
    _delta_net_recurrent_sane_mod.delta_net_recurrent_sane_single_step
)
